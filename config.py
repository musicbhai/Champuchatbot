...
API_ID = int(getenv("API_ID", 21696829))
API_HASH = getenv("API_HASH", "c0e23cf3dfa118239951a88bd0f4c6b7")
BOT_TOKEN = getenv("BOT_TOKEN", None)
OWNER_ID = int(getenv("OWNER_ID", 7569863273))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "HeavenChatGroup")
UPDATE_CHNL = getenv("UPDATE_CHNL", "AuraVisual")
OWNER_USERNAME = getenv("OWNER_USERNAME", "YourAyush")
